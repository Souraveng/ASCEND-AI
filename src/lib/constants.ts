import { Home, LineChart, FileText, Bot, Workflow, Settings, Users, Mic, MessagesSquare, User, Briefcase } from 'lucide-react';
...
const toolsNav = {
  ...
  items: [
    ...
    { key: 'cvforge', label: 'CV Forge', icon: Briefcase, auth: true }, // <--- ADDED HERE
